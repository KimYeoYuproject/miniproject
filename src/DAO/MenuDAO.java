...
public class MenuDAO {
    private List<MenuDTO> menuVO = new ArrayList<>();

    {
        menuVO.add(new MenuDTO("아메리카노", "커피", 2000, LocalDateTime.now()));
        menuVO.add(new MenuDTO("레몬에이드", "에이드", 3500, LocalDateTime.now()));
        menuVO.add(new MenuDTO("딸기주스", "에이드", 4000, LocalDateTime.now()));
        menuVO.add(new MenuDTO("카페라떼", "커피", 3000, LocalDateTime.now()));
        menuVO.add(new MenuDTO("카라멜마끼야또", "커피", 3500, LocalDateTime.now()));
        menuVO.add(new MenuDTO("카페모카", "커피", 3500, LocalDateTime.now()));
        menuVO.add(new MenuDTO("자몽에이드", "에이드", 3500, LocalDateTime.now()));
        menuVO.add(new MenuDTO("커피프라페", "스무디", 3900, LocalDateTime.now()));
        menuVO.add(new MenuDTO("딸기요거트스무디", "스무디", 3900, LocalDateTime.now()));
    }
    ...
    public List<MenuDTO> findAllByMenu() {
        this.menuVO.sort(Comparator.comparing(MenuDTO::getName));
        return this.menuVO;
    }
